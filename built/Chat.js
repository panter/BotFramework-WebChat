...
var Chat = (function (_super) {
    ...
    Chat.prototype.handleKeyDown = function (evt) {
    ...
    Chat.prototype.render = function () {
        ...
        return (React.createElement(react_redux_1.Provider, { store: this.store },
            React.createElement("div", { className: "wc-chatview-panel", onKeyDown: this.handleKeyDown, ref: function (div) { return _this.chatviewPanel = div; }, tabIndex: 0 },
                header,
                React.createElement(MessagePane_1.MessagePane, null,
                    React.createElement(History_1.History, null)),
                React.createElement(Shell_1.Shell, { ref: function (shellWrapper) { return _this.shellRef = shellWrapper.getWrappedInstance(); } }),
                resize)));
    };
    return Chat;
}(React.Component));
